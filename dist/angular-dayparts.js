...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template.html',
    '<div class="dayparts">\n' +
    '  <select class="{{selectElementClass}}" ng-model="selectedPresetItem" ng-options="item.value as item.label disable when item.disabled for item in presetItems" ng-change="selectedPresetItemChanged()"></select>\n' +
    '\n' +
